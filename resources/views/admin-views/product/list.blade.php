        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm-4 col-12">
                    <h1 class="page-header-title"> {{\App\CentralLogics\Helpers::get_local_language_translate(translate('messages.items'),translate('messages.list'))}} <span class="badge badge-soft-dark ml-2" id="foodCount">{{$items->total()}}</span></h1>
                </div>
